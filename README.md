...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:000000,100:39FF14&height=200&section=header&text=NDZUMA&fontSize=80&fontFamily=monospace&fontColor=39FF14&animation=fadeIn&fontAlignY=38&desc=SOFTWARE%20ENGINEER%20%2F%20ML%20ENGINEER%20%E2%80%94%20LONDON&descAlignY=58&descSize=16&descColor=ffffff" width="100%"/>
...
```bash
$ whoami
> CS & AI Student @ Kingston University London
> Aspiring Software Engineer / ML Engineer
> Building things that touch real people — not just demos
$ location
> London, UK 🇬🇧
$ status
> [ACTIVE] Shipping. Learning. Breaking things intentionally.
```
...
```
NAME      : Ndzuma
ROLE      : Software Engineer & ML Engineer (in the making)
BASE      : London, United Kingdom
MISSION   : Build software that impacts real people
            while touching new technology every single day
INTERESTS : AI/ML Systems · Backend Architecture · Security Tools
            Rent Prediction Models · Hackathons · Open Source
CURRENTLY : [ pulsefolio.net ] — portfolio analytics platform
            [ rent-prediction-model ] — ML model trained on scraped data
            [ probeTool ] — AI-powered security scanner (Go + Next.js)
```
...
<table align="center" width="100%">
  <tr>
    <td width="50%" valign="top">
      <h3 align="center">
        <a href="https://www.pulsefolio.net/">⚡ PulsePortfolio</a>
      </h3>
      <p align="center">
        <a href="https://www.pulsefolio.net/">
          <img src="https://img.shields.io/badge/LIVE-%E2%86%92_pulsefolio.net-39FF14?style=for-the-badge&labelColor=000000" />
        </a>
      </p>
      <p>
        Multi-asset portfolio analytics platform. Track 700k+ instruments — stocks, crypto, ETFs, real estate. 
        Pro-grade risk analysis, BYOAI private queries, benchmarking, and a full REST API.
        Built for investors who want institutional tools without institutional price tags.
      </p>
      <p>
        <img src="https://img.shields.io/badge/Next.js-000?style=flat-square&logo=next.js&logoColor=39FF14"/>
        <img src="https://img.shields.io/badge/FastAPI-000?style=flat-square&logo=fastapi&logoColor=39FF14"/>
        <img src="https://img.shields.io/badge/TypeScript-000?style=flat-square&logo=typescript&logoColor=39FF14"/>
      </p>
    </td>
    <td width="50%" valign="top">
      <h3 align="center">
        <a href="https://github.com/ndzuma/probeTool">🔍 probeTool</a>
      </h3>
      <p align="center">
        <a href="https://github.com/ndzuma/probeTool">
          <img src="https://img.shields.io/badge/OPEN_SOURCE-%E2%86%92_github-39FF14?style=for-the-badge&labelColor=000000" />
        </a>
      </p>
      <p>
        AI-powered security scanner with a Next.js web dashboard, system tray integration, 
        and CLI. Single Go binary with embedded frontend. Supports multiple AI providers 
        via OpenRouter. Auto-updates, SQLite history, Homebrew tap.
      </p>
      <p>
        <img src="https://img.shields.io/badge/Go-000?style=flat-square&logo=go&logoColor=39FF14"/>
        <img src="https://img.shields.io/badge/Next.js-000?style=flat-square&logo=next.js&logoColor=39FF14"/>
        <img src="https://img.shields.io/badge/Claude_AI-000?style=flat-square&logo=anthropic&logoColor=39FF14"/>
      </p>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <h3 align="center">🏠 Rent Prediction Model</h3>
      <p align="center">
        <img src="https://img.shields.io/badge/STATUS-IN_PROGRESS-FF6B00?style=for-the-badge&labelColor=000000" />
      </p>
      <p>
        ML regression model trained on scraped UK rental listings data. 
        Predicting rent prices by location, property type, and features.
        End-to-end pipeline: scraping → cleaning → feature engineering → model training → API.
      </p>
      <p>
        <img src="https://img.shields.io/badge/Python-000?style=flat-square&logo=python&logoColor=39FF14"/>
        <img src="https://img.shields.io/badge/scikit--learn-000?style=flat-square&logo=scikitlearn&logoColor=39FF14"/>
        <img src="https://img.shields.io/badge/FastAPI-000?style=flat-square&logo=fastapi&logoColor=39FF14"/>
      </p>
    </td>
    <td width="50%" valign="top">
      ...
      <p align="center">
        <img src="https://img.shields.io/badge/MODE-ALWAYS_BUILDING-39FF14?style=for-the-badge&labelColor=000000" />
      </p>
      <p>
        Hackathons are where ideas get stress-tested at 3am. Competing regularly, 
        shipping fast, and building with whoever wants to solve hard problems.
        If you're organising one in London — I'm in.
      </p>
      <p>
        <img src="https://img.shields.io/badge/London_Based-000?style=flat-square&logoColor=39FF14"/>
        <img src="https://img.shields.io/badge/Fast_Shipper-000?style=flat-square&logoColor=39FF14"/>
        <img src="https://img.shields.io/badge/Team_Player-000?style=flat-square&logoColor=39FF14"/>
      </p>
    </td>
  </tr>
</table>
...
[![Email](https://img.shields.io/badge/EMAIL-ndzumaxx@gmail.com-000000?style=for-the-badge&logo=gmail&logoColor=39FF14&labelColor=000000)](mailto:ndzumaxx@gmail.com)
[![Threads](https://img.shields.io/badge/THREADS-@whitefaalconn-000000?style=for-the-badge&logo=threads&logoColor=39FF14&labelColor=000000)](https://www.threads.net/@whitefaalconn)
[![X](https://img.shields.io/badge/X-@_whitefaalconn-000000?style=for-the-badge&logo=x&logoColor=39FF14&labelColor=000000)](https://x.com/_whitefaalconn)
[![PulsePortfolio](https://img.shields.io/badge/PROJECT-pulsefolio.net-000000?style=for-the-badge&logo=vercel&logoColor=39FF14&labelColor=000000)](https://www.pulsefolio.net/)
